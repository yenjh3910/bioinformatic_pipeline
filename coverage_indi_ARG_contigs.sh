...
#Build index
bowtie2-build ~/indi_ARG_contigs/${i}_ARG_contigs.fa ${i}_ARG_contigs.index

#Quantification coverage
bowtie2 -x ~/indi_ARG_contigs/index/${i}_ARG_contigs.index -1 ~/clean_read/${i}_1.fastq.gz -2 ~/clean_read/${i}_2.fastq.gz -S ${i}_ARG_contigs.sam -p 16
