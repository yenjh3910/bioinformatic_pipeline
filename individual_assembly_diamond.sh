...
#SARG detection
diamond blastx -d ~/Database/arg-oap/SARG_manual.fasta.dmnd -q ~/cdhit_individual_assembly/${i}.nucl.uniq --id 70 -p 16 -e 1e-10 -k 1 --query-cover 70 -o ~/individual_assembly_diamond/SARG/${i}_assembly.nucl.SARG.dmnd
