...
#ARG-SARG detection
diamond blastx -d ~/Database/arg-oap/SARG_manual.fasta.dmnd -q ~/cdhit/bin.$i.nucl.uniq --id 80 -p 16 -e 1e-10 -k 1 --query-cover 70 -o ~/ARGs_SARG/bin.$i.nucl.uniq.SARG.dmnd
