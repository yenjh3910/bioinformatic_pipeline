...
prodigal -i ~/megahit/megehit_individual/${i}_assembly/final.contigs.fa -o ~/assembly_prodigal/${i}_assembly.prodigalout -a ~/assembly_prodigal/prodigal/${i}_assembly.prot -d ~/assembly_prodigal/prodigal/${i}_assembly.nucl -c -p meta
